<template>
  ...
  >
    ...
    <section class="movies w-screen h-auto 
...
export default {
  ...
  data() {
    return {
      banner: {
        image: "https://files.tecnoblog.net/wp-content/uploads/2022/02/demolidor-edited.jpeg",
        logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Daredevil_Logo.svg/1280px-Daredevil_Logo.svg.png",
        description: "Matt Murdock foi vítima de um acidente que o deixou cego quando adolescente, mas que também o dotou de superpoderes sensoriais."
      },
      movies: [],
      categories: [],
    };
